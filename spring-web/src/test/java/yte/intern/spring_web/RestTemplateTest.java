...
import yte.intern.spring_web.dto.Comment;
import yte.intern.spring_web.dto.Post;
...
public class RestTemplateTest {
    ...
    public void postEkle(){
        ...
        var request = RequestEntity.post(uri).body(new Post(3L,null,"test title","test body"));
    ...
    public void commentGuncelle(){
        ...
        var request = RequestEntity.put(uri).body(new Comment(12L,5L,"asdasd","sad@asd.com","test body"));
